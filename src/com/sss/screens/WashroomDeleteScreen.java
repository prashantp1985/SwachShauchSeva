...
public class WashroomDeleteScreen {
    ...
    public WashroomDeleteScreen(JFrame frame) {
...
//        panel.setBounds(new Rectangle(425, 25, 300, 300));
       ...
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        ...
        serviceListCombo.addItemListener(new ItemListener() {
       ...
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        ...
        int outputLength = 70;
        int outputWidth = 250;
        jTable1.setBounds(new Rectangle(inputStartX, newY, outputWidth, outputLength));
        model.addColumn("Sr.No");
        model.addColumn("Address");
        model.addColumn("Action");
        jTable1.setModel(model);
        model.addRow(new Object[]{"Sr.No","Address","Action"});
        model.addRow(new Object[]{"1", "bangur nagar washroom, near bangur nagar signal, goregaon(west), mumbai","Delete"});
		 model.addRow(new Object[]{"2", "motilal nagar washroom, motilal nagar, goregaon(west), mumbai","Delete"});
		 model.addRow(new Object[]{"3", "prashant washroom, near bangur nagar post office, goregaon(west), mumbai","Delete"});
		 jTable1.setVisible(false);
		 
		 newY = newY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
		 newY = newY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
       
        classifyButton.setText("Delete");
        ...
        thanksLabel.setText("Records deleted");
