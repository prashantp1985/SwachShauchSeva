...
public class WashroomAddScreen {
    ...
    private JLabel markLabel = new JLabel();
    
    private JLabel markLabel1 = new JLabel();
    
    private JLabel thanksLabel = new JLabel();
    
    public WashroomAddScreen(JFrame frame) {
...
//        panel.setBounds(new Rectangle(425, 25, 300, 300));
       ...
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        ...
        paneLabel.setText("Address : ");
        paneLabel.setBounds(new Rectangle(inputStartX, newY, length, FrameCreator.STANDARD_HEIGHT));
        
        textPane.setBounds(new Rectangle(inputStartX + offset1, newY, length1, FrameCreator.STANDARD_HEIGHT));
        
        newY = newY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        
        markLabel.setText("Mark Location : ");
        markLabel.setBounds(new Rectangle(inputStartX, newY, length, FrameCreator.STANDARD_HEIGHT));
        
        markLabel1.setText("O");
        markLabel1.setBounds(new Rectangle(inputStartX + offset1, newY, length, FrameCreator.STANDARD_HEIGHT));
        
        newY = newY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        
        classifyButton.setText("Add");
        ...
        thanksLabel.setText("Records added");
...
//		componentList.add(closeButton);
		...
		componentList.add(serviceListCombo);
	   	...
	   	componentList.add(paneLabel);
	   	componentList.add(textPane);
		componentList.add(markLabel);
		componentList.add(markLabel1);
