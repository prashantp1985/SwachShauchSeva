...
public class WashroomOutputScreen {
    ...
    public WashroomOutputScreen(JFrame frame) {
...
//        panel.setBounds(new Rectangle(425, 25, 300, 300));
       ...
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        ...
        model.addColumn("Maps");
        jTable1.setModel(model);
        model.addRow(new Object[]{"Sr.No","Address","Maps"});
        model.addRow(new Object[]{"1", "bangur nagar washroom, near bangur nagar signal, goregaon(west), mumbai","O"});
		 model.addRow(new Object[]{"2", "motilal nagar washroom, motilal nagar, goregaon(west), mumbai","O"});
		 model.addRow(new Object[]{"3", "prashant washroom, near bangur nagar post office, goregaon(west), mumbai","O"});
       ...
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        ...
        feedbackButton.setBounds(new Rectangle(oldX, newY, length, FrameCreator.STANDARD_HEIGHT));
        feedbackButton.addActionListener(new ActionListener() {
                                          public void actionPerformed(ActionEvent e) {
                                        	  feedbackOnClick(frame);
                                          }
...
//        jTable1.setEditable(false);
        ...
        componentList.add(jDeveloperInformationLabel);
	   	componentList.add(feedbackButton);
