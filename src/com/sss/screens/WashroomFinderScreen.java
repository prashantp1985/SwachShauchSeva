...
public class WashroomFinderScreen {
	
	 private JLabel inputDetailsLabel = new JLabel();
    ...
    public WashroomFinderScreen(JFrame frame) {
...
//        panel.setBounds(new Rectangle(425, 25, 300, 300));
        ...
        inputDetailsLabel.setBounds(new Rectangle(inputStartX, inputStartY, length, FrameCreator.STANDARD_HEIGHT));
        ...
        selectStateLabel.setBounds(new Rectangle(inputStartX, inputStartY, length, FrameCreator.STANDARD_HEIGHT));
        
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        stateListCombo = new JComboBox();
        stateListCombo.setBounds(new Rectangle(inputStartX + offset1, inputStartY, length1, FrameCreator.STANDARD_HEIGHT));
        ...
        selectCityLabel.setBounds(new Rectangle(inputStartX, inputStartY, length, FrameCreator.STANDARD_HEIGHT));
        
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        cityListCombo = new JComboBox();
        cityListCombo.setBounds(new Rectangle(inputStartX + offset1, inputStartY, length1, FrameCreator.STANDARD_HEIGHT));
        ...
        selectLocationLabel.setBounds(new Rectangle(inputStartX, inputStartY, length, FrameCreator.STANDARD_HEIGHT));
        
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        locationListCombo = new JComboBox();
        locationListCombo.setBounds(new Rectangle(inputStartX + offset1, inputStartY, length1, FrameCreator.STANDARD_HEIGHT));
        ...
        selectServiceLabel.setBounds(new Rectangle(inputStartX, inputStartY, length, FrameCreator.STANDARD_HEIGHT));
        
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        serviceListCombo = new JComboBox();
        serviceListCombo.setBounds(new Rectangle(inputStartX + offset1, inputStartY, length1, FrameCreator.STANDARD_HEIGHT));
       ...
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        ...
        classifyButton.setBounds(new Rectangle(oldX, newY, length, FrameCreator.STANDARD_HEIGHT));
        ...
        clearButton.setBounds(new Rectangle(oldX, newY, length, FrameCreator.STANDARD_HEIGHT));
        ...
        outputDetailsLabel.setText("Output Details : ");
        outputDetailsLabel.setBounds(new Rectangle(outputX, outputY, length, FrameCreator.STANDARD_HEIGHT));
        
        outputY = outputY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        
//        jTable1.setEditable(false);
        
        jTable1.setBounds(new Rectangle(outputX, outputY, outputWidth, outputLength));
        ...
        componentList.add(inputDetailsLabel);
    ...
    private void searchOnClick() {
    	if (! validateInputs()) {
			JOptionPane.showMessageDialog(null,
			 ...
			 model.addRow(new Object[]{"bangur nagar washroom, near bangur nagar signal, goregaon(west), mumbai"});
			 model.addRow(new Object[]{"motilal nagar washroom, motilal nagar, goregaon(west), mumbai"});
			 model.addRow(new Object[]{"prashant washroom, near bangur nagar post office, goregaon(west), mumbai"});
		}
      }	
     ...
     */
     public static void main(String args[]) {
         java.awt.EventQueue.invokeLater(new Runnable() {
             public void run() {
                 new WashroomFinderScreen(FrameCreator.createFrame());
             }
         });
     }
