...
public class WashroomEditScreen {
    ...
    public WashroomEditScreen(JFrame frame) {
...
//        panel.setBounds(new Rectangle(425, 25, 300, 300));
       ...
       // inputStartY = inputStartY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
        ...
        model.addRow(new Object[]{"1", "bangur nagar washroom, near bangur nagar signal, goregaon(west), mumbai","Edit"});
		 model.addRow(new Object[]{"2", "motilal nagar washroom, motilal nagar, goregaon(west), mumbai","Edit"});
		 model.addRow(new Object[]{"3", "prashant washroom, near bangur nagar post office, goregaon(west), mumbai","Edit"});
		 
		 newY = newY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
		 newY = newY + FrameCreator.STANDARD_COMPONENT_DIFFERENCE;
       
        classifyButton.setText("Edit");
        ...
        thanksLabel.setText("Records editted");
